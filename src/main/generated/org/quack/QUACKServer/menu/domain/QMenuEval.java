...
public class QMenuEval extends EntityPathBase<MenuEval> {
    ...
    private static final long serialVersionUID = -219068401L;
    ...
    public final EnumPath<org.quack.QUACKServer.menu.enums.MenuEnum.MenuEvalType> menuEvalType = createEnum("menuEvalType", org.quack.QUACKServer.menu.enums.MenuEnum.MenuEvalType.class);
