...
public class QRestaurantCategory extends EntityPathBase<RestaurantCategory> {
    ...
    private static final long serialVersionUID = -1518928315L;
    ...
    public final EnumPath<org.quack.QUACKServer.domain.restaurant.enums.RestaurantEnum.RestaurantCategoryType> restaurantCategoryName = createEnum("restaurantCategoryName", org.quack.QUACKServer.domain.restaurant.enums.RestaurantEnum.RestaurantCategoryType.class);
