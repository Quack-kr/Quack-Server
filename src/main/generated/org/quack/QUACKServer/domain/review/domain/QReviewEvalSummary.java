...
public class QReviewEvalSummary extends EntityPathBase<ReviewEvalSummary> {
    ...
    private static final long serialVersionUID = -1794710387L;
    ...
    public final EnumPath<org.quack.QUACKServer.domain.review.enums.ReviewEnum.ReviewKeywordType> keywordType = createEnum("keywordType", org.quack.QUACKServer.domain.review.enums.ReviewEnum.ReviewKeywordType.class);
    ...
    public final EnumPath<org.quack.QUACKServer.domain.review.enums.ReviewEnum.ReviewTag> reviewSummaryTag = createEnum("reviewSummaryTag", org.quack.QUACKServer.domain.review.enums.ReviewEnum.ReviewTag.class);
