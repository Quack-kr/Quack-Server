...
public class QReviewLike extends EntityPathBase<ReviewLike> {
    ...
    private static final long serialVersionUID = 1032971220L;

    public static final QReviewLike reviewLike = new QReviewLike("reviewLike");

    public final EnumPath<org.quack.QUACKServer.domain.review.enums.ReviewEnum.ReviewLikeType> likeType = createEnum("likeType", org.quack.QUACKServer.domain.review.enums.ReviewEnum.ReviewLikeType.class);
